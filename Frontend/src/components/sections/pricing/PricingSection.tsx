      ...
      <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-0">
        <div className="w-full rounded-xl bg-gray-800 p-6 sm:w-1/2 sm:rounded-r-none sm:p-8 lg:w-1/3">
          <div className="mb-4">
            ...
            <p className="text-emerald-300">{pricing.starterKit.description}</p>
          </div>
          <div className="mb-4">
            ...
            <span className="ms-3 text-sm text-emerald-200">
          ...
          <a
            ...
            className="block rounded-lg bg-gray-500 px-8 py-3 text-center text-sm font-bold text-gray-100 ring-emerald-300 outline-hidden transition duration-100 hover:bg-gray-600 focus-visible:ring-3 active:text-gray-300 md:text-base"
          >
            {pricing.starterKit.purchaseBtnTitle}
          </a>
        </div>

        <div className="w-full rounded-xl bg-linear-to-tr from-blue-700 to-blue-500 p-6 shadow-xl sm:w-1/2 sm:p-8">
          <div className="mb-4 flex flex-col items-start justify-between gap-4 lg:flex-row">
            ...
            <span className="bg-opacity-50 order-first inline-block rounded-full bg-blue-200/60 px-3 py-1 text-center text-xs font-bold tracking-wider text-blue-700 uppercase lg:order-none">
              {pricing.badge}
            </span>
          </div>
          <div className="mb-4">
            ...
            <span className="ms-3 text-blue-200">
          ...
          <a
            ...
            className="bg-opacity-50 block rounded-lg bg-blue-200/40 px-8 py-3 text-center text-sm font-bold text-neutral-100 ring-blue-300 outline-hidden transition duration-300 hover:bg-blue-300 focus-visible:ring-3 active:bg-blue-400 md:text-base"
          >

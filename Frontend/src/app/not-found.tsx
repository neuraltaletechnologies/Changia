    ...
    <section className="grid h-svh place-content-center">
      <div className="mx-auto max-w-(--breakpoint-xl) px-4 py-8 lg:px-6 lg:py-16">
        <div className="mx-auto max-w-(--breakpoint-sm) text-center">
          <h1 className="text-dark mb-4 text-7xl font-extrabold text-blue-600 lg:text-9xl dark:text-blue-400">
            404
          </h1>
          ...
          <button
            ...
            className="group inline-flex items-center justify-center gap-x-2 rounded-lg border border-transparent bg-blue-600 px-4 py-3 text-sm font-bold text-neutral-50 ring-zinc-500 transition duration-300 focus-visible:ring-3 outline-hidden hover:bg-blue-700 active:bg-blue-700 dark:ring-zinc-200 dark:focus:outline-hidden"
          >
            {btnTitle}

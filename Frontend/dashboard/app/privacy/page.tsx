        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-left space-y-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
              <li>Donor Phone Number: Required to route the mobile money transaction via the payment gateway.</li>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold">3. Mobile Money PIN Safeguard</h2>
            <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/30 p-4 rounded-xl flex gap-3 text-amber-800 dark:text-amber-300">
              ...
              <div>
                ...
                <p className="text-xs leading-relaxed mt-1">
                  Changia NEVER stores, sees, or asks for your mobile money PIN. The PIN is entered exclusively within the operator-controlled approval prompt. We will never send you messages asking for your PIN.
                </p>
              </div>
            </div>
          </div>
